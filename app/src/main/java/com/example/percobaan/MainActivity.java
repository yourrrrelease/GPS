...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int FAST_UPDATE_INETRVAL = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationRequest.setInterval(1000 * FAST_UPDATE_INETRVAL);
    ...
    private void updateGPS() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            fusedLocationProviderClient.getLastLocation(null).addOnSuccessListener(this, new OnSuccessListener<Location>() {
                @Override
